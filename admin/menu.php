...
$i++;
$adminmenu[$i]['title'] = _MI_ALBUMLINK_ADMENU2;
$adminmenu[$i]['link'] = 'admin/main.php';
$adminmenu[$i]['desc'] = _MI_ALBUMLINK_ADMENU2;
$adminmenu[$i]['icon'] = 'images/admin/category.png';
$i++;
$adminmenu[$i]['title'] = _MI_ALBUMLINK_ADMENU3;
$adminmenu[$i]['link'] = 'admin/power.php';
$adminmenu[$i]['desc'] = _MI_ALBUMLINK_ADMENU3;
