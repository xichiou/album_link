<?php
define('_MB_TADLINK_SHOW_EDIT_BITEM0', '顯示數量');
define('_MB_TADLINK_SHOW_EDIT_BITEM1', '顯示縮圖？');
define('_MB_TADLINK_SHOW_EDIT_BITEM2', '顯示站名？');
...
define('_MB_TADLINK_SHOW_SORT', '排序方式？');
define('_MB_TADLINK_SHOW_HEIGHT', '每列高度（0 為自動）：');
