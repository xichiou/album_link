        ...
        <div class="row">
          ...
          <div class="col-sm-6 text-right">
            <{if $isAdmin or $uid==$now_uid}>
              <a href="index.php?op=album_link_form&link_sn=<{$link_sn}>" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a>
              <a href="javascript:delete_album_link_func(<{$link_sn}>)" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a>
            <{/if}>
            <a href="index.php?cate_sn=<{$cate_sn}>" class="btn btn-sm btn-info"><{$smarty.const._MD_ALBUMLINK_CATE_INFO2}></a>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <form action="index.php" method="post" class="form" role="form">
                ...
                <tr id="tr_<{$link.link_sn}>">
                  <td>
                    <label class="checkbox-inline">
                      ...
                      <{if $link.overdue}>
                        <span class="badge badge-important"><{$smarty.const._MD_ALBUMLINK_OVERDUE}></span>
                      <{/if}>

                    </label>
                  </td>
                  <td>
                    <a href="javascript:delete_album_link_func(<{$link.link_sn}>)" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a>
                    <a href="index.php?op=album_link_form&mode=batch&link_sn=<{$link.link_sn}>" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a>
                  </td>
                </tr>
          ...
          <span class="form-text text-muted"><{$smarty.const._MD_ALBUMLINK_DRAG_SORT}></span>
            ...
            <div class="col-sm-9">
              ...
              <{if $isAdmin or $link.uid==$now_uid}>
                <div class="pull-right">
                  <a href="javascript:delete_album_link_func(<{$link.link_sn}>)" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a>
                  <a href="index.php?op=album_link_form&link_sn=<{$link.link_sn}>" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a>
                </div>
              <{/if}>
